...
/**
 * Strings for component 'qtype_sphinx', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
 * @subpackage sphinx
...
$string['pluginname'] = 'sphinx';
$string['pluginname_help'] = 'In response to a question (that may include an image) the respondent writes an answer of a paragraph or two. The sphinx question will not be assigned a grade until it has been reviewed by a teacher and manually graded.';
$string['pluginname_link'] = 'question/type/sphinx';
$string['pluginnameadding'] = 'Adding an sphinx question';
$string['pluginnameediting'] = 'Editing an sphinx question';
